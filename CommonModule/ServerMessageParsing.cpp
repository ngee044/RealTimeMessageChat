...
namespace Network
{
ServerMessageParsing::ServerMessageParsing(const std::string& message, const server_message_parsing_callback& callback)
...
auto ServerMessageParsing::working() -> std::expected<void, std::string>
{
